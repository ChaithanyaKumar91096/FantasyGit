...
public class TestNG_TimeOut {
  ...
  @Test(priority=0,description="Top Menus")
  ...
  @Disabled
  @Test (description="Register",priority=2)
  ...
  @Test(description = "SignIn",priority=1,timeOut=9000)
  public void test_02() throws InterruptedException {
	...
	Thread.sleep(1000);
	driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("Hello@789");
	Thread.sleep(1000);
